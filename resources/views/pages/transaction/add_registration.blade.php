                          ...
                          <div class="form-body">
                              <div class="row">
                                  ...
                                  <div class="col-12 d-flex justify-content-end">
                                      ...
                                      <button type="submit" class="btn btn-outline-primary mr-1 btn_insert_registration"><i class='bx bx-plus-circle' ></i> Submit</button>
                                  </div>
                              </div>
                          </div>
                      	</form>
...
didOpen: (toast) => {
	...
	$(document).on('submit', '#InsertRegistration', function(e) {
	    e.preventDefault();
	    var route = $('#InsertRegistration').data('route');
	    var form_data = $(this);
	    $.ajaxSetup({headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr('content')}});
	  	Pace.track(function(){
		  	$.ajax({
