...
@section('content')
@if(auth()->user()->can('view category partner')/* && $some_other_condition*/)
<section id="description" class="card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            @if(auth()->user()->can('create category partner')/* && $some_other_condition*/)
            <button type="button" class="btn btn-primary round addPC"><i class="bx bx-plus-circle"></i> Create Partner Category</button>
            @else
            <button type="button" class="btn btn-primary round" onclick="return alert('You no have access !')"><i class="bx bx-plus-circle"></i> Create Partner Category</button>
            @endif
